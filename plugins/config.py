...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8049169659:AAEXf8qEpDfhTWQZMZT7X9i64PMrlfH4Tbg")
    ...
    DEF_WATER_MARK_FILE = "@AKIMAX06"

    BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "").split())

    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://usdpay:usdpay@cluster0.6dumo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002084819782"))
    LOGGER = logging
    OWNER_ID = int(os.environ.get("OWNER_ID", "6859451629"))
    SESSION_NAME = "UploaderXNTBot"
    UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002084819782")

    TG_MIN_FILE_SIZE = 2194304000
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "ak_forword_3_bot")
    ADL_BOT_RQ = {}
